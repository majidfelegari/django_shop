...
from .models import PaymentModel, PayementStatusType
...
class PayementVerifyView(View):
    def get(self, request, *args, **kwargs):
        ...
        payment_obj.status = PayementStatusType.success.value if status_code in {
            100, 101} else PayementStatusType.failed.value
